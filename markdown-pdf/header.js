 ...
 */
 module.exports = function (info) {
     return {
         height: '2cm',
         contents: '<div style="text-align: right;"><strong>' + info.fileInfo.name + '</strong> to ' + '<span style="color: #E91E63; font-size: 120%; text-transform: uppercase;">omnetpp_primer</span></div>'
