...
# 1.2 我的初衷
&#160; &#160; &#160; &#160;由于我在学习使用<b>OMNeT++</b>的过程中，遇到很多问题，虽然在安装的过程中，没有遇到什么阻碍，如果只是简单的想仿真自带的例子，估计就只需要修改仿真程序配置文件，在加上能分析仿真结果就行，但是想要完全自己写一个仿真程序，这些是完全不够的，这方面可以上<b>YouTobe</b>上搜索，一堆<b>OMNeT++</b>仿真的程序，基本都是自己开发的，而在国内，各论文上的<b>OMNeT++</b>仿真应该是自己写的，但是基本不会提供源代码，更别说网上一堆<b>OMNeT++</b>仿真程序，基本是软件自带的例程。</br>
